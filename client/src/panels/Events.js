...
import {Button, Group, Header, HorizontalCell, HorizontalScroll, Panel, PanelHeader, View} from '@vkontakte/vkui';
            ...
            <Panel id="horizontalCell">
                ...
                <Group header={<Header aside={
                    <Button stretched size="l" mode="secondary"
                            onClick={() => props.setActiveStory(ROUTES.SEARCHEVENTS)} data-to="searchevents">
                        Показать все
                    </Button>
                }>Рекомендации</Header>}>
                    <HorizontalScroll>
